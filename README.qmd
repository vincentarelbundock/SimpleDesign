...
fit = function(data) {
  model = lm(Y ~ T, data = data)
  results = tidy_estimator(OLS = model, term = "T")
  return(results)
}
...
fit = function(data) {
  model = lm(Y ~ T, data = data)
  results = tidy_estimator(model, term = "T")
  return(results)
}
```
